...
public class LoadDatabase {
    ...
    CommandLineRunner initDb(UsuarioRepository usuarioRepository, TareaRepository tareaRepository){
        return args -> {
            ...
            Tarea proyectoBootcamp = new Tarea("proyectoBootcamp", "Proyecto final del bootcampo de microservicios con java",
                    Constantes.TAREA_ESTADO_EN_PROGRESO, LocalDate.of(2025,6,2), leonardo);
            Tarea presentacionTrabajo = new Tarea("presentacionTrabajo", "Hacer presentación del trabajo pendiente",
                    Constantes.TAREA_ESTADO_COMPLETADA, LocalDate.of(2025, 4, 23), mich);
            Tarea notaVerde = new Tarea("notaVerde", "Nota verde para el siguiente programa de 31 minutos",
